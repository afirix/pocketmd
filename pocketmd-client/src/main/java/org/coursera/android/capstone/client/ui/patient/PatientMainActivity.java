...
public class PatientMainActivity extends UserActivity {

    @InjectView(R.id.patient_main_menu)
    ListView mainMenu;
    ...
    @OnItemClick(R.id.patient_main_menu)
    public void onItemClick(final int position) {
        final Class<? extends Activity> activityToStart;
        switch (position) {
            case 0:
                activityToStart = PatientCheckInActivity.class;
                break;
            case 1:
                activityToStart = PatientSettingsActivity.class;
                break;
            default:
